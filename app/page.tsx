        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            "@graph": [
              {
                "@type": "SoftwareApplication",
                "@id": "https://campussentinel.com/#attendance-ai",
                "name": "AI Attendance Management",
                "applicationCategory": "EducationalApplication",
                "description": "AI-powered attendance management that identifies absentee patterns, flags irregularities, and provides actionable insights for schools.",
                "featureList": [
                  "Attendance trend analysis",
                  "Chronic absentee detection",
                  "Class-wise attendance insights",
                  "Early warning signals for dropouts"
                ],
                "isPartOf": {
                  "@id": "https://campussentinel.com/#software"
                }
              ...
              {
                "@type": "SoftwareApplication",
                "@id": "https://campussentinel.com/#academics-ai",
                "name": "AI Academic Performance Analytics",
                "applicationCategory": "EducationalApplication",
                "description": "AI-driven academic analytics that evaluates student performance, identifies learning gaps, and supports data-backed academic decisions.",
                "featureList": [
                  "Performance trend analysis",
                  "Subject-wise weakness detection",
                  "Student risk profiling",
                  "Outcome-based academic insights"
                ],
                "isPartOf": {
                  "@id": "https://campussentinel.com/#software"
                }
              ...
              {
                "@type": "SoftwareApplication",
                "@id": "https://campussentinel.com/#fees-ai",
                "name": "AI Fee Management & Forecasting",
                "applicationCategory": "EducationalApplication",
                "description": "AI-powered fee management that tracks collections, predicts delays, and highlights financial risks for school administrators.",
                "featureList": [
              ...
              {
                "@type": "SoftwareApplication",
                "@id": "https://campussentinel.com/#operations-ai",
                "name": "AI School Operations Intelligence",
                "applicationCategory": "EducationalApplication",
                "description": "AI-driven operational intelligence that analyzes administrative data to improve efficiency and proactive decision-making in schools.",
                "featureList": [
